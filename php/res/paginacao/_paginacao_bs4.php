...
<nav aria-label="Page navigation">
    <ul class="pagination">
        ...
        <?php
            ...
            if (($pg+1) <= $quant_pg) {
                echo "<li class='page-item'><a class='page-link' href='".$PHP_SELF."?pg=".($pg+1)."$link' aria-label='próximo' >";
            } else {
                    echo "<li class='page-item disabled'><a class='page-link' href='#' aria-label='próximo'>";
            }
            ?>
