...
*/
    ...
    class CustomLog{
        ...
        private function time_elapsed_B($secs){
            $bit = array(
                ' ano'        => (int) bcmod(bcdiv($secs, 31556926, 8), 12, 8 ),
                ' semana'     => (int) bcmod(bcdiv($secs, 604800, 8), 52, 8),
                ' dia'        => (int) bcmod(bcdiv($secs, 86400, 8), 7, 8),
                ' hora'       => (int) bcmod(bcdiv($secs, 3600, 8), 24, 8),
                ' minuto'     => (int) bcmod(bcdiv($secs, 60, 8), 60, 8),
                ' segundo'    => (int) bcmod($secs, 60, 8),
                );
